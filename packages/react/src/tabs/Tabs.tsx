...
const ITEM = [
  ...
  // the row clip paint on BOTH axes, so a ring offset 2px outward — 4px of it
  // once the 2px width is counted — was cut off top and bottom and rendered as
  // two disconnected vertical bars. Measured, and it predates the rule change.
  // Padding on the row cannot buy the room: it would move the row's padding-box
  // bottom away from the tabs and detach the inset rule. specs/tabs.md.
